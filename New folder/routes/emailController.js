...
//       service: 'Gmail',
//       auth: {
//         user: 'giridharank957@gmail.com', // Replace with your Gmail email address
//         pass: 'pzqyigdrwryeqfly' // Replace with your Gmail password
//       }
//     });

//     const mailOptions = {
//       from: 'giridharank957@gmail.com',
//       to: recipientEmail,
//       subject: 'Journey Jet Booking Invoice',
...
async function sendEmailWithAttachment(recipientEmail, pdfBuffer, pdfFileName) {
  try {
    const transporter = nodemailer.createTransport({
      service: 'Gmail',
      auth: {
        user: 'giridharank957@gmail.com', 
        pass: 'pzqyigdrwryeqfly' 
      }
    });
