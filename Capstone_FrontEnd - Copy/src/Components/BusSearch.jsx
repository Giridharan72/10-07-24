...
//                               <div>
//                                 {pickup} - {dropoff}
//                               </div> // Wrap in a div instead of nested p tags
//                             ) : (
//                               <div>
...
//                         <div
//                           className={
//                             expandedBusId === bus.busId ? "show" : "hide"
//                           }
//                         >
//                           {bus.Route &&
//                             bus.Route.busRoute && ( // Check if bus.Route and bus.Route.busRoute are defined
//                               <div className="dropdown">
//                                 <button
//                                   className="btn btn-secondary dropdown-toggle"
//                                   type="button"
//                                   id={`dropdownRoutes${bus.busId}`}
...
//                                   aria-labelledby={`dropdownRoutes${bus.busId}`}
//                                 >
//                                   {bus.Route.busRoute.map((route, index) => (
//                                     <li key={index}>
//                                       <span>{route}</span>
...
// import { faBus, faMapMarkerAlt, faClock, faMoneyBill, faUser, faRoute, faChevronDown, faChevronUp } from '@fortawesome/free-solid-svg-icons';
...
//           <div className="col-md-3">
//             <label htmlFor="pickup" className="form-label">
//               <FontAwesomeIcon icon={faMapMarkerAlt} /> Pick Up
//             </label>
//             <input
//               type="text"
//               id="pickup"
...
//           <div className="col-md-3">
//             <label htmlFor="dropoff" className="form-label">
//               <FontAwesomeIcon icon={faMapMarkerAlt} /> Drop Off
//             </label>
//             <input
//               type="text"
//               id="dropoff"
...
//           <div className="col-md-3">
//             <label htmlFor="datepicker" className="form-label">
//               <FontAwesomeIcon icon={faClock} /> Select Date
//             </label>
//             <input
//               type="date"
//               id="datepicker"
...
//                         <FontAwesomeIcon icon={faBus} /> {bus.busName}
//                       </h5>
//                       <h6 className="card-subtitle mb-2 text-muted">
//                         {bus.busNumber}
//                       </h6>
...
//                             {isSearchPerformed ? (
//                               <div>
//                                 <FontAwesomeIcon icon={faMapMarkerAlt} /> {pickup} - {dropoff}
//                               </div> // Wrap in a div instead of nested p tags
//                             ) : (
//                               <div>
//                                 <FontAwesomeIcon icon={faMapMarkerAlt} /> {bus.Route.from} - {bus.Route.to}
//                               </div>
//                             )}
//                             <div>{bus.busType}</div>
//                           </>
...
//                           <>
//                             <small className="text-muted">
//                               <FontAwesomeIcon icon={faClock} /> Departure: {bus.Route.departure}
//                             </small>
//                             <br />
//                             <small className="text-muted">
//                               <FontAwesomeIcon icon={faClock} /> Arrival: {bus.Route.arrival}
//                             </small>
//                           </>
//                         )}
//                       </div>
...
//                     <div className="d-flex justify-content-between">
//                       <p className="card-text"><FontAwesomeIcon icon={faMoneyBill} /> Fare: ₹ {bus.fare}</p>
//                       <p className="card-text"><FontAwesomeIcon icon={faUser} /> Capacity: {bus.capacity}</p>
//                       <div>
//                         {/* Use onClick to toggle dropdown visibility */}
//                         <div
//                           className={
...
//                                   data-bs-toggle="dropdown"
//                                   aria-expanded="false"
//                                   onClick={() => toggleRoutesDropdown(bus.busId)} // Toggle dropdown on click
//                                 >
//                                   <FontAwesomeIcon icon={faRoute} /> Routes Covered
//                                   <FontAwesomeIcon icon={expandedBusId === bus.busId ? faChevronUp : faChevronDown} className="ms-2" />
//                                 </button>
//                                 <ul
//                                   className="dropdown-menu"
//                                   aria-labelledby={`dropdownRoutes${bus.busId}`}
...
//                       </button>
//                     </div>
//                     {bus.Facility && bus.Facility.facilities && bus.Facility.facilities.length > 0 && (
//   <div className="mt-3">
//     <h6>Facilities:</h6>
//     <p>{bus.Facility.facilities.join(', ')}</p>
//   </div>
// )}
              ...
              <div key={bus.busId} className="col-md-12 mb-4">
                <div className="card h-100 d-flex flex-column">
                  <div className="card-body">
                    ...
                    <div className="d-flex justify-content-between">
                      <p className="card-text">
                        <FontAwesomeIcon icon={faMoneyBill} /> Fare: ₹ {bus.fare}
                      </p>
                      <p className="card-text">
                        <FontAwesomeIcon icon={faUser} /> Capacity: {bus.capacity}
                      </p>
                      <div>
                        <div
                          className={
                            ...
                            bus.Route.busRoute && (
                              <div className="dropdown">
                                <button
                                  ...
                                  aria-expanded="false"
                                  onClick={() =>
                                    toggleRoutesDropdown(bus.busId)
                                  }
                                >
                                  <FontAwesomeIcon icon={faRoute} /> Routes Covered
                                  <FontAwesomeIcon
                    ...
                    {bus.Facility && bus.Facility.facilities && (
                      <div className="mt-3">
                        <h6>Facilities:</h6>
                        <div className="facility-icons">
                          {bus.Facility.facilities.map((facility, index) => {
                            switch (facility) {
                              case "TV":
                                return (
                                  <FontAwesomeIcon
