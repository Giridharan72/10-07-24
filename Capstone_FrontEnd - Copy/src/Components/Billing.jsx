...
// // // //             generatePDF(bookingData);
// // // //             alert('Payment successful and PDF generated!');
// // // //             navigate('/');
// // // //           }}
// // // //           amount={cartTotal}
// // // //         />
...
// //   const [paymentModalOpen, setPaymentModalOpen] = useState(false); // State to manage the payment modal
...
// //     // Proceed with booking logic as before

// //     // Once booking is confirmed, open the payment modal
...
const Billing = () => {
  ...
  const handleConfirmBooking = async () => {
    ...
    const bookingData = {
      customerName: customerDetails?.name || 'N/A',
      phoneNumber: customerDetails?.phoneNumber || 'N/A',
      email: customerEmail || 'N/A', // Use the entered email
      address: customerDetails?.address || 'N/A',
      busId: bus?.busId || 'N/A',
      selectedSeats: selectedSeats || [],
      passenger_details: passengerDetails,
